        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <form role="form" method="post" action="<?php echo site_url("page/savecategory");?>">
                    ...
                    <?php 
                                                                    foreach ($this->cm->gettablemain_category() as $row) {
                                                                      echo "<tr>
                                                                          ...
                                                                          <td><a href='".site_url('page/deletecategory/'.$row->category_id)."'><button type='button' class='btn btn-danger'>Delete</button></a>
                                                                      </tr>";  
                                                                    }
                                                                 ?>
