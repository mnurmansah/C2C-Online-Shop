...
<!-- Sidebar end=============================================== -->
    ...
    <div class="well">
	<h3> Welcome! <strong><?php echo $this->session->userdata('seller_username') ?></strong> to your account profile</h3>
	<?php
            //notifikasi
	...
	<div class="well">
     ...
     <form class="form-horizontal" action="<?php echo site_url('frontend/seller_postproduct') ?>" method="Post" enctype="multipart/form-data">

		 <div class="control-group">
			<label class="control-label" for="SubCategoryProduct">Sub Category Product<sup>*</sup></label>
			<div class="controls">
 			<select class="form-control" name="seller_subcategory" placeholder="Select Sub Category">
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="ProductName" name="seller_productname" placeholder="Product Name" required>
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label" for="ProductCondition">Product Condition<sup>*</sup></label>
			<div class="controls">
 			<select class="form-control" name="seller_productcondition" placeholder="Select Product Condition">
 				<option>New</option>
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			  <input type="text" id="ProductPrice" name="seller_productprice" placeholder="Product Price" required>
			</div>
		 </div>
		 <div class="control-group">
			<label class="control-label" for="ProductDescription">Product Description<sup>*</sup></label>
			<div class="controls">
              <textarea class="input-xxlarge" type="text" rows="3" id="ProductDescription" name="seller_productdescription" placeholder="Product Description" required>
			  </textarea>
			</div>
		 </div>
	 <div class="control-group">
		<label class="control-label" for="seller_productimage">Product Image <sup>*</sup></label>
		<div class="controls">
		  <input type="file" id="seller_productimage" name="seller_productimage">
		</div>
	  </div>
	  <div class="control-group">
			<div class="controls">
